...
public class MovingCube : MonoBehaviour
{
    ...
    private void SplitCubeOnX(float breakZ,float direction)
    {
        ...
        float fallingBlockSizeX = transform.localScale.x - newXSize;
        ...
        float fallingBlockXPos = cubeEgde + fallingBlockSizeX / 2f * direction;

        DropCube(fallingBlockXPos, fallingBlockSizeX);
    }
